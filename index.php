              ...
              <div class="modal-body" style="padding:	2rem; padding-top: 0; padding-bottom: 0;">
                <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                  <li class="nav-item active">
                    <a class="nav-link" href="index.php" style="color: #E7E7E8;">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="promethee-php.php">Promethee</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="promethee-php-mysql.php">Analisa</a>
                  </li>
                </ul>
              </div>
      ...
      <div>
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <h1 class="title-text-big">The best path<br class=" d-lg-block d-none"> for the best solution</h1>
          ...
          <div class="d-flex flex-lg-row flex-column align-items-center">
            ...
            <div class="flex-grow-1 text-lg-start text-center card-text">
              <h3 class="card-title text-white">
                System for Making Decisions in 30 minutes
              </h3>
              <p class="card-caption">
                Our tools for Making Decision helps an People
                understand<br class="d-none d-lg-block" />
                market or business development.
              </p>
            </div>
            <div class="card-btn-space">
              <button class="btn btn-card text-white">Try Now</button>
              <button class="btn btn-outline" onclick="document.location='login.php';">Login</button>
            </div>
          </div>
        </div>
      </div>
    </div>
<div class="footer-2-3 container-xxl mx-auto position-relative p-0" style="font-family: 'Poppins', sans-serif" data-aos="fade-up">
