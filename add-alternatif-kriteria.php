<?php
	...
	{
		mysqli_query($db, "INSERT INTO alternatif_kriteria(id_alternatif, id_kriteria, id, nilai) VALUES('$_POST[id_alternatif]', '$_POST[id_kriteria]','$_POST[id]', '$_POST[nilai]')");
        ...
        <header> 
            ...
            <main>
                    <div class="container-fluid">
                        <h1 class="mt-2 mb-5 text-center">Tambah Data Alternatif Kriteria</h1>
                            <form id="form1" name="form1" method="post" action="">
                              <table class="table table-bordered col-4 mx-auto">
                                <tr>
                                  <th scope="row">Alternatif</th>
                                  <td><select name="id_alternatif" class="form-control" id="id_alternatif">
                                      <option value=""></option>
                                      <?php
                              ...
                              ?>
                                ...
                                <tr>
                                  ...
                                  <td><select name="id_kriteria" class="form-control" id="id_kriteria">
                                      <option>---Pilih Kriteria---</option>
                                      <?php
                                            $querykriteria = mysqli_query($db, "SELECT * FROM kriteria ORDER BY nama_kriteria ASC")or die(mysqli_error($db));
                                ...
                                <tr>
                                  ...
                                  <td><input type="text" class="form-control" name="nilai" id="nilai" /></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
