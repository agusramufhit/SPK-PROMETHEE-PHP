        ...
        <header> 
            ...
            <main>
                    <div class="container-fluid">
                        <h1 class="mt-2 mb-5 text-center">Tambah Data Alternatif</h1>
                        
                            <form id="form1" name="form1" method="post" action="">
                              <table class="table table-bordered col-4 mx-auto">
                                <tr>
                                  <td>Nama Alternatif Produk</td>
                                  <td><input type="text" class="form-control" name="nama_alternatif" id="nama_alternatif" /></td>
                                </tr>
                                <tr>
                                  <td>Deskripsi</td>
                                  <td><textarea name="deskripsi" class="form-control" cols="30" rows="4" id="deskripsi"></textarea></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
