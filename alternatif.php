        ...
        <header> 
            ...
            <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 mb-5">Data Alternatif</h1>    
                        <table class="table table-bordered">
                            <tr>
                            <th scope="col">ID Alternatif</th>
                            <th scope="col">Nama Alternatif Produk</th>
                            <th scope="col">Deskripsi</th>
                            <th scope="col" class="text-center"><a href="add-alternatif.php" class="btn btn-secondary">Add</a></th>
                            </tr>
                            <?php
                            ...
                            ?>
                            <tr>
                            <th scope="row"><?php echo $dataalternatif['id_alternatif']; ?></th>
                            <td><?php echo $dataalternatif['nama_alternatif']; ?></td>
                            <td><?php echo $dataalternatif['deskripsi']; ?></td>
                            <td class="text-center"><a href="edit-alternatif.php?id_alternatif=<?php echo $dataalternatif['id_alternatif']; ?>" class="btn btn-danger col">Edit</a> 
                            <a href="del-alternatif.php?id_alternatif=<?php echo $dataalternatif['id_alternatif']; ?>" class="btn btn-success col">Del</a></td>
                            </tr>
                            <?php
                                }
                            ?>
