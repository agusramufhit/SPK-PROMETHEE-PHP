        ...
        <header> 
            ...
            <main>
                    <div class="container-fluid">
                        <h1 class="mt-2 mb-5 text-center">Edit Data Alternatif</h1>
                             <?php
                              ...
                              ?>
                                <form id="form1" name="form1" method="post" action="">
                                  <table class="table table-bordered col-4 mx-auto">
                                    <tr>
                                      <th scope="row">ID Alternatif</th>
                                      <td><input type="text" class="form-control" name="id_alternatif" id="id_alternatif" readonly value="<?php echo $dataalternatif['id_alternatif']; ?>" /></td>
                                    </tr>
                                    <tr>
                                      <th scope="row">Nama Alternatif Produk</th>
                                      <td><input type="text" class="form-control" name="nama_alternatif" id="nama_alternatif" value="<?php echo $dataalternatif['nama_alternatif']; ?>" /></td>
                                    </tr>
                                    <tr>
                                      <th scope="row">Deskripsi</th>
                                      <td><textarea name="deskripsi" class="form-control" cols="30" rows="4" id="deskripsi"><?php echo $dataalternatif['deskripsi']; ?></textarea></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
